 ...
 * 
 ***********************************/
#define LCD_SCK			(1 << PB5)
#define LCD_MOSI		(1 << PB3)
#define LCD_DC			(1 << PB1)
#define LCD_SCE			(1 << PB0)
#define LCD_RESET		(1 << PD7)
#define LCD_BACKLIGHT	(1 << PB2)


#define RESET_ON 	PORTD &= ~LCD_RESET;	
#define RESET_OFF 	PORTD |= LCD_RESET;	
#define SCE_ON		PORTB &= ~LCD_SCE;
#define SCE_OFF		PORTB |= LCD_SCE;
#define DC_ON		PORTB &= ~LCD_DC;
#define DC_OFF		PORTB |= LCD_DC;
#define BACKLIGHT_ON PORTB |= LCD_BACKLIGHT;
#define BACKLIGHT_OFF PORTB &= ~LCD_BACKLIGHT;
